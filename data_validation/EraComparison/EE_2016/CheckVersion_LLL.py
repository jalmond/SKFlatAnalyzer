...
hist_bases = [
    "HNL_WZ_SR1_ThreeLepton_CR",
    "HNL_WZVBF_ThreeLepton_CR",
    "HNL_WZVBF2_ThreeLepton_CR",
    "HNL_WZ_SR3_ThreeLepton_CR",
    "HNL_WZB_ThreeLepton_CR",
    "HNL_ZNPEl_ThreeLepton_CR",
    "HNL_ZNPMu_ThreeLepton_CR"
]
...
for ID in id_versions:
    for hist_base in hist_bases:
        ...
        era_bins = [0, 1, 2, 3]
        era_offsets = {"MuMuMu": -0.2, "EEE": 0.0, "EMuL": 0.2}
        colors = {"MuMuMu": ROOT.kRed+1, "EEE": ROOT.kBlue+1, "EMuL": ROOT.kGreen+2}
        markers = {"MuMuMu": 20, "EEE": 21, "EMuL": 22}
        ...
        canvas.Print(f"results_LLL/{hist_base}_{ID}_TotalBackground_AllChannels.png")
        canvas.Print(f"results_LLL/{hist_base}_{ID}_TotalBackground_AllChannels.pdf")
