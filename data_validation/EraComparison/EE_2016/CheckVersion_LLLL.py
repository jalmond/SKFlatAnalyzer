...
for ID in id_versions:
    for hist_base in hist_bases:
        ...
        era_offsets = {"MuMuMuMu": -0.2, "EEEE": 0.0, "EMuLL": 0.2}
        colors = {"MuMuMuMu": ROOT.kRed+1, "EEEE": ROOT.kBlue+1, "EMuLL": ROOT.kGreen+2}
        markers = {"MuMuMuMu": 20, "EEEE": 21, "EMuLL": 22}
        ...
        canvas.Print(f"results_LLLL/{hist_base}_{ID}_TotalBackground_AllChannels.png")
        canvas.Print(f"results_LLLL/{hist_base}_{ID}_TotalBackground_AllChannels.pdf")
