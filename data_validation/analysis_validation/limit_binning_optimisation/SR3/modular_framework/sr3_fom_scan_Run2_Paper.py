...
def main():
    ...
    global_scan_outputs = run_parallel_scans(
        data, FLAVOURS, MASSES, global_mass_config, n_workers=NCORE
    )

    global_final_scan = evaluate_scan_results(
        data, global_scan_outputs, global_mass_config
    )
    print("\n==============================")
    ...
    for flav in FLAVOURS:
        ...
        make_mass_plot_multi(
            ...
            out_tag="sr3_compare_standard_vs_global_" + standard_config["scan_name"]
        )
    ...
    for flav in global_best_met_map:
        ...
        make_mass_plot_multi(
            ...
            out_tag="sr3_global_metscan_" + global_mass_config["scan_name"]
        )
