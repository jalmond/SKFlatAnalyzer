...
def debug_compare_binnings_per_boundary(data, MASSES, FLAVOURS, ERAS):
    ...
    CATEGORIES = [
        "LowJet_DV_MET{X}_LTcut",
        "HighJet_DV_MET{X}_LTcut",
        "LowJet_DV_MET{X}_GTcut",
        "HighJet_DV_MET{X}_GTcut",
    ]
...
def print_sr3_bin_table(data, flav, mass):
    ...
    for era in ERAS:
        ...
        cats = [
            f"LowJet_DV_MET{boundary}_LTcut",
            f"HighJet_DV_MET{boundary}_LTcut",
            f"LowJet_DV_MET{boundary}_GTcut",
            f"HighJet_DV_MET{boundary}_GTcut",
        ]
