...
def parse_sr3_category(cat):
    ...
    is_ltcut = "bin" in parts[3]  # True/False                                                                                                                                                                                             
...
def print_sr3_bin_table(data, flav, mass):
    ...
    for era in ERAS:
        ...
        cats = [
            f"LowJet_HT_LT_MET{boundary}_bin1",
            f"LowJet_HT_LT_MET{boundary}_bin2",
            f"LowJet_HT_LT_MET{boundary}_bin3",
	    f"HighJet_HT_LT_MET{boundary}_bin1",
            f"HighJet_HT_LT_MET{boundary}_bin2",
            f"HighJet_HT_LT_MET{boundary}_bin3",
