...
def main():
    ...
    Plots = [["ExtraLep/All_El_NonMatched","All_El_NonMatched CB",[1]],  ["ExtraLep/All_Muon_NonMatched","All_Muon_NonMatched",[1]], ["ExtraLep/All_Tau_NonMatched","All_Tau_NonMatched",[1]], ["Standard/Lepton_pt","Lepton_pt",[2]]]
    IDs = ["HNL_ULIDv2_ANv4","HNL_ULIDv2_pileup_medium","HNL_ULIDv2_pileup_medium2","HNL_ULIDv2_presel","HNL_ULIDv2_presel_mod"]
    ...
    for j_histname, j_label,j_rebin in Plots:
        for j_id in IDs:
            for j_flavour in Flavours:
                hist_bases.append(["HNL_HighMassSR2_InvBJet_CR", j_id,j_histname, j_label, j_rebin, j_flavour])
                hist_bases.append(["HNL_HighMassSR2_InvMET_CR",  j_id,j_histname, j_label, j_rebin, j_flavour])
                hist_bases.append(["HNL_HighMassSR2_M500_CR",  j_id,j_histname, j_label, j_rebin, j_flavour])
                hist_bases.append(["HNL_HighMassSR2_M750_CR",  j_id,j_histname, j_label, j_rebin, j_flavour])
