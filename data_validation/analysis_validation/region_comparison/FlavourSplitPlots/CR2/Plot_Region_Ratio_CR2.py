...
background_files = [
    ["HNL_ControlRegionTwo_CF.root", "Chargeflip"],
    ["HNL_ControlRegionTwo_Conv.root", "X#gamma"],
    ["HNL_ControlRegionTwo_Fake.root", "Nonprompt"],
    ["HNL_ControlRegionTwo_TTV.root", "TTV"],
    ["HNL_ControlRegionTwo_VVV.root", "VVV"],
    ["HNL_ControlRegionTwo_WZ.root", "WZ"],
    ["HNL_ControlRegionTwo_WW.root", "WW"],
    ["HNL_ControlRegionTwo_ZZ.root", "ZZ"],
...
data_files = [
    "HNL_ControlRegionTwo_Data.root",
]


data_file = "HNL_ControlRegionTwo_Data.root"
...
regions = ["HNL_HighMassSR2_InvBJet_CR","HNL_HighMassSR2_InvMET_CR","HNL_HighMassSR2_Inclusive"]

hist_bases = []

for region  in regions:
    hist_bases.append([region, "HNL_ULIDv2_ANv4", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_pileup_medium", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_presel", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_presel_mod", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_veto_id_one", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_veto_id_two", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_Pt20", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_Pt25", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_Pt30", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_Pt30Tau", "LL", ["MuMu", "EE", "EMu", "LL"]])
    hist_bases.append([region, "HNL_ULIDv2_TauVeto", "LL", ["MuMu", "EE", "EMu", "LL"]])
...
Path("results_cr2_ratio/").mkdir(exist_ok=True)
Path("results_cr2_ratio/"+Plot_Version).mkdir(exist_ok=True)
...
try:
    ...
    for hist_base, hist_config, flavour, channels in hist_bases:
        ...
        output_file = f"results_cr2_ratio/{Plot_Version}/{hist_base}_{hist_config}_{flavour}_ratio_stacked_histogram.png"
