...
background_files = [
    ["HNL_ControlRegionTwo_CF.root", "#splitline{Charge flip}{background}"],
    ["HNL_ControlRegionTwo_ZG.root", "Z#gamma"],
    ["HNL_ControlRegionTwo_XConv.root", "W/VV/t #plus #gamma"],
    ["HNL_ControlRegionTwo_Fake.root", "#splitline{MisId. Lepton}{background}"],
    ["HNL_ControlRegionTwo_Top_Higgs.root", "Top,Higgs,VVV"],
