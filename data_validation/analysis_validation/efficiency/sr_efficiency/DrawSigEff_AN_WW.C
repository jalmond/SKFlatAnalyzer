...
void DrawSigEff_AN_WW(){
  ...
  //  DrawConfig("Feb14","MuMu","2018","HNL_SR","HNTightV2");
  //  DrawConfig("Feb14","EE","2018","HNL_SR","HNTightV2");
...
void DrawConfig(TString DateTag,TString Flavour, TString era, TString filepath,  TString ID){
  ...
  for (auto year : eras){
    ...
    else if(Flavour == "EE")h_eff_WW->GetYaxis()->SetTitle("m_{N} Selection efficiency for ee channel");
    else h_eff_WW->GetYaxis()->SetTitle("m_{N} Selection efficiency for e#mu channel");
