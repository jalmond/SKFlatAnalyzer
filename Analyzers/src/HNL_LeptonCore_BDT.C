...
void HNL_LeptonCore::DefineBDTLimitBins(){
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_90"]  = {-0.1,-0.05,0,0.03,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_95"]  = {-0.1,-0.05,0,0.03,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_100"] = {-0.1,-0.05,0,0.03,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_125"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.16,0.18,0.22,1}; //12
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_150"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,1}; 
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_200"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.16,0.18,1}; //10
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_250"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.15,0.17,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_300"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.15,1}; 
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_400"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.15,1}; 
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_500"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,1};

  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_85"]  = {-0.1,-0.05,0.03,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_90"]  = {-0.1,-0.05,0.03,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_95"]  = {-0.1,-0.05,0.03,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_100"] = {-0.1,-0.05,0,0.03,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.25,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_125"] = {-0.2,-0.05,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_150"] = {-0.2,-0.05,0,0.05,0.1,0.12,0.14,0.16,0.18,0.2,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_200"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.16,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_250"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.17,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_300"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.14,0.16,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_400"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,0.15,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_500"] = {-0.2,-0.1,-0.05,0,0.05,0.1,0.12,1};
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2017_200"] = {-0.1,-0.05,0,0.05,0.1,0.12,0.16,0.18,0.2,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2017_250"] = {-0.1,-0.05,0,0.05,0.1,0.12,0.16,0.18,0.2,1};
  map_bdt_limit_bins["SR3BDT_MuMu_2017_300"] = {-0.1,-0.05,0,0.05,0.1,0.12,0.16,0.18,1};
