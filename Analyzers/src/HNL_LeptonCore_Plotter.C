...
void HNL_LeptonCore::Fill_Plots(AnalyzerParameter param, TString region,  TString plot_dir, 
  ...
  for(unsigned int i=0; i < jets.size(); i++){
    ...
    if(i == 0)     FillHist( plot_dir+ region+ "/AK4Jets/Jet_0_pt",  jets[i].Pt() , w, 400, 0., 2000., "AK4 Jet p_{T} GeV");
  ...
  if(jets.size() > 1){
    ...
    FillHist( plot_dir+ region+"/VBF/Jet_dR_jet1_lep1",  jets[ijet1].DeltaR(*leps[0]) ,w, 100,  0., 5,"#DeltaR(j,l1)");
    FillHist( plot_dir+ region+"/VBF/Jet_dR_jet1_lep2",  jets[ijet1].DeltaR(*leps[1]) ,w, 100,  0., 5,"#DeltaR(j,l1)");
    FillHist( plot_dir+ region+"/VBF/Jet_dR_jet2_lep1",  jets[ijet2].DeltaR(*leps[0]) ,w, 100,  0., 5,"#DeltaR(j,l1)");
    FillHist( plot_dir+ region+"/VBF/Jet_dR_jet2_lep2",  jets[ijet2].DeltaR(*leps[1]) ,w, 100,  0., 5,"#DeltaR(j,l1)");
  }
