#include "SkimTree_AK8BDT.h"

void SkimTree_AK8BDT::initializeAnalyzer(){

  outfile->cd();
  cout << "[SkimTree_AK8BDT::initializeAnalyzer()] gDirectory = " << gDirectory->GetName() << endl;
  ...
  if(DataYear==2016){
    ...
    cout << "[SkimTree_AK8BDT::initializeAnalyzer] DataYear is wrong : " << DataYear << endl;
  }

  cout << "[SkimTree_AK8BDT::initializeAnalyzer] triggers to skim = " << endl;
  for(unsigned int i=0; i<triggers.size(); i++){
    cout << "[SkimTree_AK8BDT::initializeAnalyzer]   " << triggers.at(i) << endl;
  }

}

void SkimTree_AK8BDT::executeEvent(){
...
void SkimTree_AK8BDT::executeEventFromParameter(AnalyzerParameter param){

}

SkimTree_AK8BDT::SkimTree_AK8BDT(){
...
void SkimTree_AK8BDT::WriteHist(){
