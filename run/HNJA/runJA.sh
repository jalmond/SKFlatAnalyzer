...
then
    ...
    SKFlat.py -a HNtypeI_JA  -l MCJA/Sig2016.txt  -n 100   --userflags Signal --nmax 150  -y 2017
    SKFlat.py -a HNtypeI_JA  -l MCJA/Sig2016.txt  --userflags SignalOS -n 100  --nmax 150  -y 2017
    SKFlat.py -a HNtypeI_JA  -l MCJA/Sig2016.txt  -n 100   --userflags Signal --nmax 150  -y 2018
    SKFlat.py -a HNtypeI_JA  -l MCJA/Sig2016.txt  --userflags SignalOS -n 100  --nmax 150  -y 2018
else
