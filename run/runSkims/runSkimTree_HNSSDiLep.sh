...
SKFlat.py -a SkimTree_SSHN -l MCDilep/MC_2016SS2l.txt -n 100  -y 2016 --skim SkimTree_SSNonIso  --nmax 150
SKFlat.py -a SkimTree_SSHN -l MCDilep/MC_2017SS2l.txt -n 100  -y 2017 --skim SkimTree_SSNonIso  --nmax 150 
SKFlat.py -a SkimTree_SSHN -l MCDilep/MC_2018SS2l.txt -n 100  -y 2018 --skim SkimTree_SSNonIso  --nmax 150
