    ...
    for dtag in datetag:
        ...
        for f in listdir("/gv0/DATA/SKFlat/"+tag+"/"+y+"/MC"+skim_tmp+"/"):
            ...
            if alias == "":
                ...
                _al_alias.append("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer/SKFlatAnalyzer/data/"+tag+"/"+y+"/Sample/CommonSampleInfo/"+al)
...
if not _AliasFound:
    ...
    for i in range(0, len(_al_sample)):
        if _al_aliasfound[i]:
            print al_sample[i] + "  file path " + al_alias[i]
        else:
            print al_sample[i] + "  missing common file in "   + al_alias[i] 
