...
if [[ $1 == "" ]]; then
	...
	SKFlat.py -a $analyzer  -l $mcpath/MC3.txt   -n 6000  --nmax 500           -e ${i}   --skim SkimTree_#DileptonBDT &
	#SKFlat.py -a $analyzer  -l $mcpath/MC2.txt   -n 6000  --nmax 500           -e ${i}   --skim SkimTree_#DileptonBDT &
